...
We have a [template repo](https://github.com/micronaut-projects/micronaut-chatbots) that we use as the single
...
[Release GitHub Action workflow](https://github.com/micronaut-projects/micronaut-chatbots/blob/master/.github/workflows/release.yml)
