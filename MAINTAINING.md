...
We have a [template repo](https://github.com/micronaut-projects/micronaut-chabots) that we use as the single
...
[Release GitHub Action workflow](https://github.com/micronaut-projects/micronaut-chabots/blob/master/.github/workflows/release.yml)
